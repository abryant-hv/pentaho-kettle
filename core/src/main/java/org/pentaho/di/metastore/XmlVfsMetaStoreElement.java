...
public class XmlVfsMetaStoreElement extends XmlMetaStoreAttribute implements IMetaStoreElement {
  ...
  public XmlVfsMetaStoreElement() {
    super();
    this.ownerPermissionsList = new ArrayList<MetaStoreOwnerPermissions>();
  }

  public XmlVfsMetaStoreElement( IMetaStoreElementType elementType, String id, Object value ) {
    super( id, value );
  ...
  public boolean equals( Object obj ) {
    ...
    if ( !( obj instanceof XmlVfsMetaStoreElement ) ) {
      return false;
    }
    return ((XmlVfsMetaStoreElement) obj ).id.equals( id );
  }
   ...
   *
   * @param filename
   *          The name of the file (for debugging purposes)
   * @param in The InputStream to load from.
   * @throws MetaStoreException
   *           In case there is a problem reading the file.
   */
  public XmlVfsMetaStoreElement( String filename, InputStream in ) throws MetaStoreException {
    this();
    setIdWithFilename( filename );

    try {
      System.err.println("Reading vfs element for: " + filename);
  ...
  public void save( OutputStream out ) throws MetaStoreException {
    try {
      System.err.println("Writing vfs element for: " + name);
   ...
   * @param element
   */
  public XmlVfsMetaStoreElement( IMetaStoreElement element ) {
    super( element );
